...
class DBWNode(object):
    def __init__(self):
        ...
        self.current_velocity_subscriber =  rospy.Subscriber('/current_velocity', TwistStamped, self.current_velocity_cb)
        self.twist_command_subscriber = rospy.Subscriber('/twist_cmd', TwistStamped, self.twist_cb)
        self.dbw_enabled_subscriber = rospy.Subscriber('/vehicle/dbw_enabled', Bool, self.dbw_enabled_cb)
